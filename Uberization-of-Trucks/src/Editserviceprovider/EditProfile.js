...
*/
  ...
  render() {if(this.state.redirect){
    return <Redirect to={{
      pathname:'/currentBidsResult',
    }}
   />;
  }
    return (
    <div id="main-editprofileserviceprovider-container">
    <div class="w3-sidebar">
  <div class="sidebar">
    <ul>
    <div id="edit1">
  <li>Edit Profile</li></div>
  <br></br>
  <li> Open Order</li>
  <br></br>
  <li><Link to="/currentBidsResult">Current bids</Link>
   ...
   <br></br>
     ...
     <div id="editprofile">
        <h3>ServiceProviderDetails</h3>
        <form method="post"  name="ServiceProviderDetails"  onSubmit= {this.submitCustomerDetails} >
